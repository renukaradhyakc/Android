...
public class ViewScreenPixel extends BaseScreen {
    ...
    public ViewScreenPixel(Context context) {
        super(context);
        android.util.Log.d("CallScreen", "Using ViewScreenPixel layout");
        ...
        btnAddMessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ViewScreenPixel.this.actionScreenResult.onAddMessage();
            }
        });
        LayoutParams btnParams = new LayoutParams(-2, -2);
        btnParams.addRule(14);
        btnParams.addRule(2, ViewScreenPixel.this.tvStatus.getId());
