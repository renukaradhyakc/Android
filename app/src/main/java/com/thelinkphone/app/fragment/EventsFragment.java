...
public class EventsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(mIsloggedIn != null)
        {
            ...
            webview.loadUrl("http://192.168.0.102:8000/events");
        }
        else
        {
    ...
    private class MyChrome extends WebChromeClient {
        ...
        public boolean onCreateWindow(WebView view, boolean isDialog,
            ...
            // 'view' is the main WebView instance from EventsFragment (EventsFragment.this.webview)
            final WebView mainWebView = EventsFragment.this.webview;
    ...
    public void onPause() {
        if (webview != null) {
            try {
                webview.onPause();
                // Clear any pending autofill operations
                webview.clearFormData();
                webview.clearCache(false);
            } catch (Exception e) {
                Log.e(TAG, "Error pausing WebView: " + e.getMessage());
            }
        }
        super.onPause();
    }
